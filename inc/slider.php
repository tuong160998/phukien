			...
			<div class="section group">
				...
				<div class="listview_1_of_2 images_1_of_2">
					<div class="listimg listimg_2_of_1">
						 <a href="details.php"> <img src="admin/uploads/<?php echo $resultXiaomi['image'] ?>" alt="" /></a>
					</div>
				    <div class="text list_2_of_1">
						<h2>Xiaomi</h2>
						<p><?php echo $fm->textShorten($resultXiaomi['productName'],35) ?></p>
						<div class="button"><span><a href="details.php?proid=<?php echo $resultXiaomi['productId'] ?>">Thêm vào giỏ</a></span></div>
				   </div>
			   </div>
			   <?php
				}}
